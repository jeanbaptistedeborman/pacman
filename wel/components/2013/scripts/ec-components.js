...
run: function () {
    ...
    updateBy: function (obj, txt) {
        var tmp = doc.createElement("div"), domer;
        tmp.innerHTML = txt;
    ...
    _unobtrusive_II: function (json) {
        var o, c, s, d, y = 0, l = false;
        _$.ajaxqueue = [];
        for (var n in json) {
            o = doc.getElementById(n);
            if (o) {
                var j = json[n], na = j["component"], dy = j["dynamic"];
                if (na) {
                    _$._pusher("list", na, o);
...
// ATTTRIBUTE
	...
	addClass		:function(elm,cls){var e=elm,c=cls;if(!c||!e){}else if(!e.className){e.className=c;}else if(typeof e=="object"){e.className=e.className+" "+c;}},
...
// AJAX
    ...
    load: function (c) {
        var u = c["url"], e = c["error"], s = c["success"], d = c["data"], f = c["dataType"], m = "GET";
